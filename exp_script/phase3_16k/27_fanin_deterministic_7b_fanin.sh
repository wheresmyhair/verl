#!/bin/bash
# 8B-scale deterministic fan-in test — fan-in enabled (min_idle=1).
# DeepSeek-R1-Distill-Qwen-7B, fork engine tp_size=4, fan-in trigger.
set -x
rm -f log_rank_*.txt
...
export RLPIPE_SGFANIN_TRACE=/home/user/profiling_sgfanin_deterministic_7b_fanin
export RLPIPE_FANIN_TOKEN_DUMP=/home/user/profiling_sgfanin_deterministic_7b_fanin
export RLPIPE_SGFANIN_FANIN_DEBUG=/home/user/profiling_sgfanin_deterministic_7b_fanin/fanin_debug.log

PROFILING_DIR=/home/user/profiling_sgfanin_deterministic_7b_fanin
rm -rf "$PROFILING_DIR"
...
python3 -m verl.trainer.main_ppo \
    ...
    2>&1 | sed 's/\x1b\[[0-9;]*m//g' | tee log_p3_sgfanin_deterministic_7b_fanin.txt
