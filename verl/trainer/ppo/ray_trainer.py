            ...
            for batch_idx, batch_dict in enumerate(self.train_dataloader):
                ...
                with _timer("step", timing_raw):
                    ...
                    with _timer("old_log_prob", timing_raw):
                        old_log_prob = self.actor_rollout_wg.compute_log_prob(batch, step=batch_idx)
                    ...
                    if self.use_reference_policy:
                        ...
                        with _timer("ref", timing_raw):
                            ref_log_prob = self.ref_policy_wg.compute_ref_log_prob(batch, step=batch_idx)
                    ...
                    if self.config.trainer.critic_warmup <= self.global_steps:
                        ...
                        with _timer("update_actor", timing_raw):
                            ...
                            actor_output = self.actor_rollout_wg.update_actor(batch, step=batch_idx)
