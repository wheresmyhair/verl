...
YOUR_RUN_NAME=$ENGINE-ROTP$ROLLOUT_TP-BSZ$INFERENCE_BATCH_SIZE-GMEM$GPU_MEMORY_UTILIZATION-TRAINTP$TRAIN_TP-TRAINPP$TRAIN_PP
...
python3 -m verl.trainer.main_ppo --config-path=./config --config-name='ppo_megatron_trainer' \
	...
	actor_rollout_ref.actor.profile.save_path=$HOME/verl_profile/trainpp$TRAIN_PP-traintp$TRAIN_TP \
